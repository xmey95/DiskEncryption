...
#### 1.1 Transparent Encryption<sup><a href="https://en.wikipedia.org/wiki/Disk_encryption#Transparent_encryption"><font size="1">Wikipedia</font></a></sup>
...
#### 1.2 Disk encryption vs. filesystem-level encryption<sup><a href="https://en.wikipedia.org/wiki/Disk_encryption#Disk_encryption_vs._filesystem-level_encryption"><font size="1">Wikipedia</font></a></sup>
...
#### 1.3 Disk encryption and Trusted Platform Module<sup><a href="https://en.wikipedia.org/wiki/Disk_encryption#Disk_encryption_and_Trusted_Platform_Module"><font size="1">Wikipedia</font></a></sup>
...
## 2. Full disk encryption<sup><a href="https://en.wikipedia.org/wiki/Disk_encryption#Full_disk_encryption"><font size="1">Wikipedia</font></a></sup>

#### 2.1 Benefici<sup><a href="https://en.wikipedia.org/wiki/Disk_encryption#Benefits"><font size="1">Wikipedia</font></a></sup>
...
#### 2.2 Il problema della chiave al boot<sup><a href="https://en.wikipedia.org/wiki/Disk_encryption#The_boot_key_problem"><font size="1">Wikipedia</font></a></sup>
...
#### 3.1 Disk Encryption Hardware<sup><a href="https://en.wikipedia.org/wiki/Disk_encryption_hardtware"><font size="1">Wikipedia</font></a></sup>
...
##### Self-Encrypted Drives<sup><a href="https://wiki.archlinux.org/index.php/Self-Encrypting_Drives"><font size="1">ArchWiki</font></a></sup>
...
#### 3.2 Disk Encryption Software<sup><a href="https://en.wikipedia.org/wiki/Disk_encryption_software"><font size="1">Wikipedia</font></a></sup>
...
PLAUSIBLE DENIABILITY<sup><a href="https://it.wikipedia.org/wiki/Negazione_plausibile"><font size="1">Wikipedia</font></a></sup>
...
- Cifratura stacked filesystem<sup><a href="https://wiki.archlinux.org/index.php/Disk_encryption#Stacked_filesystem_encryption"><font size="1">ArchWiki</font></a></sup>
...
- Cifratura Block device<sup><a href="https://wiki.archlinux.org/index.php/Disk_encryption#Block_device_encryption"><font size="1">ArchWiki</font></a></sup>
...
#### 6.1 Cifratura stacked filesystem<sup><a href="https://wiki.archlinux.org/index.php/Disk_encryption#Stacked_filesystem_encryption"><font size="1">ArchWiki</font></a></sup>
...
- eCryptfs<sup><a href="https://wiki.archlinux.org/index.php/ECryptfs"><font size="1">ArchWiki</font></a></sup>
...
#### 6.2 Cifratura Block device<sup><a href="https://wiki.archlinux.org/index.php/Disk_encryption#Block_device_encryption"><font size="1">ArchWiki</font></a></sup>
...
- dm-crypt + LUKS<sup><a href="https://wiki.archlinux.org/index.php/Dm-crypt/Encrypting_an_entire_system#LVM_on_LUKS"><font size="1">ArchWiki</font></a></sup>
...
Per i fini della crittografia del disco<sup><a href="https://wiki.archlinux.org/index.php/Disk_encryption#Basic_principle"><font size="1">ArchWiki</font></a></sup>, ogni dispositivo a blocchi (o file nel caso di crittografia di stacked filesystem) è diviso in settori di uguale lunghezza, per esempio 512 byte (4096 bit). La cifratura/decifratura avviene per ogni singolo settore, quindi il settore "n" del dispositivo a blocchi/file immagazzinerà la versione cifrata del settore "n" dei dati originali.
...
- dm-crypt + LUKS per i dispositivi a blocchi
  ...
  Questo tool è stato utilizzato per effettuare una Non-Root Disk Encryption su una chiavetta USB<sup><a href="https://wiki.archlinux.org/index.php/Dm-crypt/Encrypting_a_non-root_file_system"><font size="1">ArchWiki</font></a></sup> e una Full Disk Encryption su una VM con Antergos.
...
## 10. Appendice A: Disk Encryption nei database<sup><a href="https://en.wikipedia.org/wiki/Database_encryption"><font size="1">Wikipedia</font></a></sup>

#### 10.1 Transparent Database Encryption (TDE)<sup><a href="https://docs.microsoft.com/it-it/sql/relational-databases/security/encryption/transparent-data-encryption-tde"><font size="1">Microsoft Docs</font></a></sup>
...
TDE garantisce che i dati sui supporti di memorizzazione fisici non possono essere letti da individui dannosi che vogliono rubarli. I dati che non possono essere letti sono inutili, riducendo così l'incentivo al furto. Forse la forza più importante attribuita a TDE è la sua trasparenza. Dato che TDE cifra tutti i dati si può dire che nessuna applicazione deve essere modificata in modo che TDE funzioni correttamente. È importante notare che TDE cifra l'intero database e il backup del database. L'elemento trasparente di TDE ha a che fare con il fatto che TDE cifra sul "livello di pagina", significa che i dati vengono crittografati quando vengono memorizzati e decrittografati quando sono chiamati nella memoria del sistema.
...
##### Gerarchia di crittografia<sup><a href="https://docs.microsoft.com/it-it/sql/relational-databases/security/encryption/transparent-data-encryption-tde"><font size="1">Microsoft Docs</font></a></sup>

<img src="gerarchy.gif" width="300">

##### Come abilitare TDE nei Database<sup><a href="https://docs.microsoft.com/it-it/sql/relational-databases/security/encryption/transparent-data-encryption-tde"><font size="1">Microsoft Docs</font></a></sup>

Tutti i DBMS permettono la possibilità di abilitare la TDE sui Database. Per fare ciò i DBMS si affidano al server ospitante per servire le chiavi opportune.
...
**SQL Server**<sup><a href="https://docs.microsoft.com/it-it/sql/relational-databases/security/encryption/transparent-data-encryption-tde"><font size="1">Microsoft Docs</font></a></sup>
...
**Oracle**<sup><a href="https://docs.oracle.com/cd/E11882_01/network.112/e40393/asotrans.htm#ASOAG9528"><font size="1">Oracle Docs</font></a></sup>
...
https://docs.microsoft.com/it-it/sql/relational-databases/security/encryption/transparent-data-encryption-tde
